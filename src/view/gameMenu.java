...
public class gameMenu {
    ...
    public static void main(String[] args){
        MusicPlayer a=new MusicPlayer("musics/Thegameofpower.wav");
        a.play();
